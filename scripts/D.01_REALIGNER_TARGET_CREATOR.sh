...
-L $CHROMOSOME \
-nt 4 \
-o $CORE_PATH/$PROJECT/REPORTS/LOCAL_REALIGNMENT_INTERVALS/$SM_TAG"_"$CHROMOSOME"_LOCAL_REALIGNMENT_INTERVALS.intervals"

END_REALIGNER_TARGET_CREATOR=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$PROJECT",D.01,REALIGNER_TARGET_CREATOR,"$HOSTNAME","$START_REALIGNER_TARGET_CREATOR","$END_REALIGNER_TARGET_CREATOR \
...
echo START_REALIGNER_TARGET_CREATOR=`date '+%s'`
