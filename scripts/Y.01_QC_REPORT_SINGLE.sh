...
# 
# ls $CORE_PATH/$PROJECT/SNV/SINGLE/WHOLE_GENOME/PASS/*.vcf.gz \
# | awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/SNV/SINGLE/WHOLE_GENOME/PASS/"SMtag[11],\
...
# 
# ls $CORE_PATH/$PROJECT/SNV/SINGLE/CODING/PASS/*.vcf.gz \
# | awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/SNV/SINGLE/CODING/PASS/"SMtag[11],\
# "| awk \x27{t++NR} {s+=($3~\x22rs\x22)} END {print \x22"SMtag[11]"\x22,(s/t*100)}\x27"}' \
# | bash \
...
# 
# ls $CORE_PATH/$PROJECT/INDEL/SINGLE/WHOLE_GENOME/PASS/*.vcf.gz \
# | awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/INDEL/SINGLE/WHOLE_GENOME/PASS/"SMtag[11],\
# "| awk \x27{count++NR} \
...
# 
# ls $CORE_PATH/$PROJECT/INDEL/SINGLE/CODING/PASS/*.vcf.gz \
# | awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/INDEL/SINGLE/CODING/PASS/"SMtag[11],\
# "| awk \x27{count++NR} \
# {count_dbsnp+=($3~\x22rs\x22)} \
# {big_i_nm+=(length($5)-length($4))>15&&$5!~\x22,\x22} \
# {big_i_nm_dbsnp+=(length($5)-length($4))>15&&$5!~\x22,\x22&&$3~\x22rs\x22} \
...
# 
# ls $CORE_PATH/$PROJECT/MIXED/SINGLE/WHOLE_GENOME/PASS/*.vcf.gz \
# | awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/MIXED/SINGLE/WHOLE_GENOME/PASS/"SMtag[11],\
...
ls $CORE_PATH/$PROJECT/MIXED/SINGLE/CODING/PASS/*.vcf.gz \
| awk '{split($1,SMtag,"/");print "zgrep -v \x22^#\x22","'$CORE_PATH'""/""'$PROJECT'""/MIXED/SINGLE/CODING/PASS/"SMtag[11],\
