...
-o $CORE_PATH/$PROJECT/INDEL/SINGLE/WHOLE_GENOME/$SM_TAG".WHOLE.GENOME.INDEL.vcf.gz"

END_EXTRACT_INDEL_WG=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$PROJECT",Q.01,EXTRACT_INDEL_WG,"$HOSTNAME","$START_EXTRACT_INDEL_WG","$END_EXTRACT_INDEL_WG \
