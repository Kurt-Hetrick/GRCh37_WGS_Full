...
-I $CORE_PATH/$PROJECT/TEMP/$SM_TAG"_X.realign.bam" \
-I $CORE_PATH/$PROJECT/TEMP/$SM_TAG"_Y.realign.bam" \
-I $CORE_PATH/$PROJECT/TEMP/$SM_TAG"_MT.realign.bam" \
-I $CORE_PATH/$PROJECT/TEMP/$SM_TAG".JUNK_ALIGNMENTS.bam" \
