...
-o $CORE_PATH/$PROJECT/VCF/SINGLE/CODING/$SM_TAG".CODING.vcf.gz"

END_EXTRACT_CODING=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$PROJECT",Q.01,EXTRACT_CODING,"$HOSTNAME","$START_EXTRACT_CODING","$END_EXTRACT_CODING \
