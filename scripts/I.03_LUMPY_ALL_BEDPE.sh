...
weight:1,\
min_mapping_threshold:20 \
>| $CORE_PATH/$PROJECT/LUMPY/VCF/$SM_TAG.LUMPY.ALL.pe.bed

END_LUMPY_ALL_BEDPE=`date '+%s'`

echo $SM_TAG"_"$PROJECT",I.01,LUMPY_ALL_BEDPE,"$HOSTNAME","$START_LUMPY_ALL_BEDPE","$END_LUMPY_ALL_BEDPE\
