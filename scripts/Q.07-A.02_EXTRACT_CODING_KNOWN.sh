...
-o $CORE_PATH/$PROJECT/TEMP/$SM_TAG".QC.Coding.Known.TiTv.vcf.gz"

END_EXTRACT_CODING_KNOWN=`date '+%s'`

HOSTNAME=`hostname`

echo $SM_TAG"_"$PROJECT",R.01,EXTRACT_CODING_KNOWN,"$HOSTNAME","$START_EXTRACT_CODING_KNOWN","$END_EXTRACT_CODING_KNOWN \
