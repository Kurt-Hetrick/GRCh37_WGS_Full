...
SCRIPT_DIR="/isilon/sequencing/Kurt/GIT_REPO/GRCh37_WGS_Full/scripts"
...
SVTYPER_DIR="/isilon/sequencing/Kurt/Programs/SVTyper/svtyper-0.0.4-4ab954c"
...
H.04_DOC_AUTO_WG_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]} \
 -j y -o $CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/LOGS/${SAMPLE_INFO_ARRAY[1]}_CREATE_EXCLUSION_BED.log \
 $SCRIPT_DIR/I.01_LUMPY_EXCLUDE_BED.sh \
...
echo \
 ...
 -hold_jid H14_A01_SORT_DISCORDANT_PE_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},H15_A01_SORT_SPLIT_READ_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},\
H.09_ALIGNMENT_SUMMARY_METRICS_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},H.08_INSERT_SIZE_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},\
I01_EXCLUSION_BED_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]} \
 -j y -o $CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/LOGS/${SAMPLE_INFO_ARRAY[1]}_LUMPY_FILTERED_VCF.log \
 $SCRIPT_DIR/J.01_LUMPY_FILTERED_VCF.sh \
 $LUMPY_DIR $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]}
}
...
H.09_ALIGNMENT_SUMMARY_METRICS_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},H.08_INSERT_SIZE_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]},\
I01_EXCLUSION_BED_${SAMPLE_INFO_ARRAY[1]}_${SAMPLE_INFO_ARRAY[0]} \
 -j y -o $CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/LOGS/${SAMPLE_INFO_ARRAY[1]}_LUMPY_FILTERED_BEDPE.log \
 $SCRIPT_DIR/J.02_LUMPY_FILTERED_BEDPE.sh \
 $LUMPY_DIR $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]}
}
...
echo \
 ...
 $SCRIPT_DIR/I.02-A.01_LUMPY_ALL_VCF_GT_BWA_M.sh \
...
echo \
 ...
 $SCRIPT_DIR/J.01-A.01_LUMPY_FILTERED_VCF_GT_BWA_M.sh \
 $SVTYPER_DIR $CORE_PATH ${SAMPLE_INFO_ARRAY[0]} ${SAMPLE_INFO_ARRAY[1]}
}
